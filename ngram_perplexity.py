...
ngram_model = open("out.txt", 'r').read().encode('utf-8').strip()
lambda1 = ""
lambda2 = ""
lambda3 = ""
...
unigram_model.pop(0)
[line.split(" ") for line in unigram_model]
unigram_dict = {}
model_words = []
...
for line in data:
    ...
    for word in line:
        ...
        calc[1] = bigram
        calc[2] = trigram
        prob = (lambda1*unigram_dict[unigram]) + (lambda2*unigram_dict[bigram]) + (lambda3*unigram_dict[trigram])
        calc[3] = math.log10(prob)
